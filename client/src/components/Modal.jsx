  ...
  return <div className='fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full h-[calc(100%-1rem)] max-h-full overflow-y-auto overflow-x-hidden bg-black/20 bg-opacity-50'>
    ...
    {/* modal content */}
      <div className='relative bg-white rounded-lg shadow-sm dark:bg-gray-300'>
        ...
        <div className='flex items-center justify-between p-4 md:p-5 border-p rounded-t  border-gray-100'>
          <h3 className='text-lg font-medium text-gray-900'>
            {title}
          </h3>
          <button type='button'  className='text-gray-900 bg-transparent rounded-lg text-sm w-8 h-8 inline-flex justify-center items-center cursor-pointer' onClick={onClose}>
