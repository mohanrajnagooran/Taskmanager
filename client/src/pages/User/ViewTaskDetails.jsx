...
const TodoCheckList = ({ text, isChecked, onChange}) => {
    return <div className='flex items-center gap-3 p-3'>
        <input type='checkbox' checked={isChecked} onChange={onChange} className='w-4 h-4 text-blue-700 bg-gray-700 border-gray-700 rounded-sm outline-none cursor-pointer' />
        <p className=''>{text}</p>
    </div>
}
