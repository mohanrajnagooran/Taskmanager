        ...
        <div className='grid grid-cols-1 md:grid-cols-4 mt-4'>
          <div className='form-card col-span-3'>
            <div className='flex items-center justify-between'>
              ...
              {taskId && (<button className='flex items-center gap-1.5 text-[13px] font-medium text-rose-500' 
            ...
            <div className='mt-4'>
              ...
              <input placeholder='Create Task Name' className='form-input' value={taskData.title} onChange={({ target }) => handleValueChange('title', target.value)} />
            </div>
            ...
            <div className='grid grid-cols-12 gap-4 mt-2'>
              <div className='col-span-6 md:col-span-4'>
                <label className='text-md font-medium text-slate-600'>Priority</label>
                <SelectDropdown 
              ...
              <div className='col-span-6 md:col-span-4'>
                ...
                <input placeholder='Create App' className='form-input' value={taskData.dueDate} onChange={({ target }) => handleValueChange("dueDate", target.value)}
                type='date'/>
              </div>
